...
| Push subscriptions | **MongoDB Atlas** — `jondonfitdb`; delivery via the browser vendor's push service | MongoDB, Inc. / vendor | VAPID keys live in redsecrets |
