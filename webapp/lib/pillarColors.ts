...
export const PILLAR: Record<Pillar, PillarInk> = {
  training: {
    ...
    badge: 'bg-green-100 text-green-600 dark:bg-green-900/30 dark:text-green-300',
  ...
  mind: {
    ...
    badge: 'bg-purple-100 text-purple-600 dark:bg-purple-900/30 dark:text-purple-300',
  ...
  all: {
    ...
    badge: 'bg-amber-100 text-amber-600 dark:bg-amber-900/30 dark:text-amber-300',
...
export const STREAK_INK = {
  day: { hex: '#f59e0b', badge: 'bg-amber-100 text-amber-600 dark:bg-amber-900/30 dark:text-amber-300', bar: 'bg-amber-500', text: 'text-amber-600 dark:text-amber-400' },
  super: { hex: '#f97316', badge: 'bg-orange-100 text-orange-600 dark:bg-orange-900/30 dark:text-orange-300', bar: 'bg-orange-500', text: 'text-orange-500 dark:text-orange-400' },
}
