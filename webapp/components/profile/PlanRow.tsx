...
// entry point to the plan page, for someone who never hit a gate.
//
// It used to open the upgrade sheet. The sheet is the REACTIVE surface — it
// exists to answer a refusal — and nothing is being refused here, so this now
// goes to /dashboard/plan, which is the page that actually explains the plan
// and what it costs.
//
...
import { tierLabel } from '@/lib/entitlementsClient'
