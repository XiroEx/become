...
export function BarTileChart({ data, height, color = '#a855f7' }: BarTileChartProps) {
  ...
  return (
    // Fill the parent both ways so the bars fit the available tile space instead
    // of overflowing a fixed pixel box (which the card then clipped).
    <div data-testid="bar-tile-chart" className="h-full w-full overflow-hidden">
      <ResponsiveContainer width="100%" height={height ?? '100%'}>
        <BarChart data={rows} margin={{ top: 4, right: 4, left: 4, bottom: 2 }}>
