...
import { getAuthPageCopy, type AuthMode } from '../lib/authPageMode'

/**
 * The one auth screen. /login and /register both render it — see
 * lib/authPageMode.ts for why they are two routes and not one route with a
 * query param.
 */
export default function AuthScreen({ mode, next }: { mode: AuthMode; next?: string }) {
