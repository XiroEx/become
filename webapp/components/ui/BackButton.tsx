 ...
 * navigates to `fallbackHref` (default the dashboard home). Client component so
 * it can be dropped into server-rendered pages too.
 */
export function BackButton({ fallbackHref = '/dashboard', className = '' }: BackButtonProps) {
