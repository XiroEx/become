...
export async function GET(request: NextRequest) {
  try {
    ...
    const defaults = { streakAtRisk: true, workoutReminder: true, mealReminder: true, reEngagement: true, chatMessage: true, mindReminder: true, goalNudge: true }
...
export async function PATCH(request: NextRequest) {
  try {
    ...
    const allowed = ['streakAtRisk', 'workoutReminder', 'mealReminder', 'reEngagement', 'chatMessage', 'mindReminder', 'goalNudge']
